...
u8 WM8978_Init(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB|RCC_AHB1Periph_GPIOC|RCC_AHB1Periph_GPIOA, ENABLE);			//使能外设GPIOB,GPIOC时钟
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化
	...
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource3,GPIO_AF_SPI3);   //PB12,AF5  I2S_LRCK
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource5,GPIO_AF_SPI3);	//PB13,AF5  I2S_SCLK 
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource15,GPIO_AF_SPI3);	//PC3 ,AF5  I2S_DACDATA 
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource7,GPIO_AF_SPI3);	//PC6 ,AF5  I2S_MCK
